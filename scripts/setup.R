"""
# Setup script for snoMatcher project
# Loads raw data, processes snoRNA box sequences,
# and generates initial plots and data files. 
...
# Need to clear the environment first -> TODO(FIX) uso yaml file cosi non ho hardcodado nulla e tolgo il problema dello snakemake e  
